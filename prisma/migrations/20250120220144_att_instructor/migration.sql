...
INSERT INTO "new_Instructor" ("active", "birthdate", "cpf", "createdAt", "cref", "email", "id", "name", "phone", "role", "updatedAt") SELECT "active", "birthdate", "cpf", "createdAt", "cref", "email", "id", "name", "phone", "role", "updatedAt" FROM "Instructor";
